  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        <li><a href="#" class="nav-link px-2 text-white">Əsas səhifə</a></li>
      ...
      <div class="form-check form-switch" id="user-activate" data-id="{{auth()->user()->id}}" style="margin-right: 22px; width: 100px; padding: 6px;">
        ...
        <label class="form-check-label" for="flexSwitchCheckDefault">{{auth()->user()->status==0? 'Offline': 'Online'}}</label>
        <input class="form-check-input" type="checkbox" {{auth()->user()->status==0? '': 'checked'}} role="switch" id="flexSwitchCheckDefault">
      </div>
      <div class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
        <a href="/home" target="_blank" style="    color: #fff;
          padding: 10px 18px;
          margin-right: 26px;

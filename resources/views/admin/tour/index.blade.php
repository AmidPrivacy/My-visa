...
<div class="bg-light p-5 rounded">
        ...
        <button type="button" class="btn btn-primary add-new-row" data-toggle="modal" data-target="#exampleModal">Yeni tur</button>
        <table class="table">
                <thead class="table-dark">
                        <tr> 
                                ...
                                <th class="table-primary">Müddət</th>
                                <th class="table-primary">Qiymət</th>
                ...
                <tbody>
                        ...
                        <tr> 
                                ...
                                <td class="table-light table-edit-field">
                                        ...
                                        <button type="button" class="btn btn-danger" onClick="removeRow({{ $item->id }}, '/admin/tour-remove/')">sil</button> 
                                </td>
                        </tr>
                        @endforeach
                </tbody>
                                ...
                                <form method="post" action="/admin/tour-add" id="my-form" enctype="multipart/form-data" id="my-form">
                                        <div class="modal-body"> 
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="price" id="price" placeholder="Qiymət daxil edin">
                                                </div>
                                                <div class="mb-3">
